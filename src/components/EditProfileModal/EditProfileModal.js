...
import UploadImageSvg from "../../assets/svg/UploadImageIcon.svg";
import CameraSvg from "../../assets/svg/CameraSvg.svg";
import CancelSvg from "../../assets/svg/cross.svg";
        ...
        <Modal onRequestClose={_toggleUploadImage} animationType='fade' visible={SelectIamgepicker} transparent={true}>
                <View style={{ flex: 1, backgroundColor: '#000000aa', justifyContent: 'flex-end' }}>
                    <View style={{
                        ...
                        <View style={{ backgroundColor: Colors.PRIMARY, flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 20, }}>
