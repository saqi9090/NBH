...
import { styles } from './MakePaymentEventsStyles'
...
const MakePaymentEventsScreen = ({ navigation, route, params, dispatch }, props) => {
			...
			<ScrollView keyboardShouldPersistTaps={Platform.OS === "android" ? "always" : "handled"}>
				...
				<View style={{ marginLeft: 20 }}>
					...
					<View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
						...
						{
							console.warn("!applePayDisabled", applePayDisabled)
						}
						{
							Platform.OS === 'ios'
								?
...
export default MakePaymentEventsScreen;